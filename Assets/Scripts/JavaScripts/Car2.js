...
function OnGUI()
{
	GUI.DrawTexture( Rect( Screen.width - 256,Screen.height/2 - 128,256,128),SpeedOmeterDial );
	var speedFactor : float = rigidbody.velocity.magnitude / topSpeed;
	var votationAngle = Mathf.Lerp(0,180,speedFactor);
	GUIUtility.RotateAroundPivot(votationAngle,Vector2(Screen.width-128,Screen.height/2));
	GUI.DrawTexture( Rect( Screen.width - 256,Screen.height/2 - 128,256,256),SpeedOmeterPointer );
